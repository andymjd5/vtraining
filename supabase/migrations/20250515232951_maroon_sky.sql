/*
  # Add Additional Super Admin User

  1. New Data
    - Creates a new super admin user with secure credentials
...
BEGIN
  ...
  FROM auth.users
  WHERE email = 'superadmin2@visiontraining.cd';
